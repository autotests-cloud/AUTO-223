...
public class AppTests extends TestBase {
    ...
    @DisplayName("Betbull test")
    void generatedTest() {
        step("open https://m.betbull.com/", () -> {
    ...
    void titleTest() {
        step("Open url 'https://m.betbull.com/'", () ->
            open("https://m.betbull.com/"));

        step("Page title should have text 'BetBull™ | 100% Deposit Match up to £50 in Free Bets'", () -> {
            String expectedTitle = "BetBull™ | 100% Deposit Match up to £50 in Free Bets";
